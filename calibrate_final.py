...
# -*- coding: utf-8 -*-
"""
Calibration finale Saint-Nazaire - version propre et rapide.
Tous les 17 paramètres libres. Fine search (0.5 min).
Imprime les paramètres JS à la fin.
"""
...
def metrics(params):
    ...
    return math.sqrt(sq_t/n)*60, math.sqrt(sq_h/n)  # minutes, meters
...
# x0: amplitude estimates from data + original SHOM G values
x0 = np.array([
    3.30, 70.3, 99.2, 49.1, 99.8, 53.7, 16.6, 191.5, 212.3,
    1.76, 0.44, 0.37, 0.238*SCALE, 0.101*SCALE, 0.072*SCALE, 0.091*SCALE, 0.060*SCALE
])
...
print('=== Nelder-Mead phase 1 (from x0) ===')
r1=minimize(cost, x0, method='Nelder-Mead', callback=cb,
            options={'maxiter':12000,'xatol':1e-7,'fatol':1e-7,'adaptive':True})
...
# Final Nelder-Mead from L-BFGS-B result
...
print('\n=== Constantes JavaScript (copier dans tide-calculator.js) ===')
